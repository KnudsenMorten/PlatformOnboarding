...
```powershell
# 0. Clone this repo.
git clone https://github.com/KnudsenMorten/PlatformOnboarding.git
cd PlatformOnboarding
...
PlatformOnboarding engines use the standard four auth methods that every community
...
+ Owner at tenant root), run PlatformOnboarding once, then rotate to Method 1/2/3 for
...
- **Bugs / feature requests:** [Issues](https://github.com/KnudsenMorten/PlatformOnboarding/issues/new/choose)
- **Questions / "has anyone tried...":** [Discussions](https://github.com/KnudsenMorten/PlatformOnboarding/discussions)

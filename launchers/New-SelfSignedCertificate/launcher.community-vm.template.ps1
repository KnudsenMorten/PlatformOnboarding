...
<#
.SYNOPSIS
    Community VM launcher for PlatformOnboarding\New-SelfSignedCertificate.
.DESCRIPTION
    Runs the New-SelfSignedCertificate engine on a Windows box in the customer's own tenant.
...
Write-Banner -Solution 'PlatformOnboarding' -Engine 'New-SelfSignedCertificate' -Flavour 'community-vm' -Description 'New-SelfSignedCertificate -- v2 ported engine under PlatformOnboarding.'

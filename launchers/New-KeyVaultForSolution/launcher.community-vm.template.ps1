...
<#
.SYNOPSIS
    Community VM launcher for PlatformOnboarding\New-KeyVaultForSolution.
.DESCRIPTION
    Runs the New-KeyVaultForSolution engine on a Windows box in the customer's own tenant.
...
Write-Banner -Solution 'PlatformOnboarding' -Engine 'New-KeyVaultForSolution' -Flavour 'community-vm' -Description 'New-KeyVaultForSolution -- v2 ported engine under PlatformOnboarding.'

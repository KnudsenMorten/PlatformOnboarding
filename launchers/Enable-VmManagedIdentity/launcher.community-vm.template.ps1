...
<#
.SYNOPSIS
    Community VM launcher for PlatformOnboarding\Enable-VmManagedIdentity.
.DESCRIPTION
    Runs the Enable-VmManagedIdentity engine on a Windows box in the customer's own tenant.
...
Write-Banner -Solution 'PlatformOnboarding' -Engine 'Enable-VmManagedIdentity' -Flavour 'community-vm' -Description 'Enable-VmManagedIdentity -- v2 ported engine under PlatformOnboarding.'

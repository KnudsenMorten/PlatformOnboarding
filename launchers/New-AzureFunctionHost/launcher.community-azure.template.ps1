...
<#
.SYNOPSIS
    Community Azure (Function / Logic App / Hybrid Worker) launcher for PlatformOnboarding\New-AzureFunctionHost.
.DESCRIPTION
    Runs the New-AzureFunctionHost engine from an Azure host that has a system-assigned MI.
...
Write-Banner -Solution 'PlatformOnboarding' -Engine 'New-AzureFunctionHost' -Flavour 'community-azure' -Description 'New-AzureFunctionHost -- v2 ported engine under PlatformOnboarding.'

...
<#
.SYNOPSIS
    Community Azure (Function / Logic App / Hybrid Worker) launcher for PlatformOnboarding\New-SelfSignedCertificate.
.DESCRIPTION
    Runs the New-SelfSignedCertificate engine from an Azure host that has a system-assigned MI.
...
Write-Banner -Solution 'PlatformOnboarding' -Engine 'New-SelfSignedCertificate' -Flavour 'community-azure' -Description 'New-SelfSignedCertificate -- v2 ported engine under PlatformOnboarding.'
...
$global:SettingsPath        = Join-Path $InstallPath 'SOLUTIONS\PlatformOnboarding\DATA'

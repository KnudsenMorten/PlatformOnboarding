...
<#
.SYNOPSIS
    Community Azure (Function / Logic App / Hybrid Worker) launcher for PlatformOnboarding\Enable-VmManagedIdentity.
.DESCRIPTION
    Runs the Enable-VmManagedIdentity engine from an Azure host that has a system-assigned MI.
...
Write-Banner -Solution 'PlatformOnboarding' -Engine 'Enable-VmManagedIdentity' -Flavour 'community-azure' -Description 'Enable-VmManagedIdentity -- v2 ported engine under PlatformOnboarding.'

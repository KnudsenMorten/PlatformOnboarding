...
<#
.SYNOPSIS
    Community Azure (Function / Logic App / Hybrid Worker) launcher for PlatformOnboarding\New-EntraApp.
.DESCRIPTION
    Runs the New-EntraApp engine from an Azure host that has a system-assigned MI.
...
Write-Banner -Solution 'PlatformOnboarding' -Engine 'New-EntraApp' -Flavour 'community-azure' -Description 'New-EntraApp -- v2 ported engine under PlatformOnboarding.'
